...
dataset_info = get_dataset_info(args.dataset, args.remove_h) # this is info about the dataset ie. name, type encoding etc.
# print("dataset_info", dataset_info) 


atom_encoder = dataset_info["atom_encoder"] # eg. {'H': 0, 'C': 1, 'N': 2, 'O': 3, 'F': 4}
atom_decoder = dataset_info["atom_decoder"]



# args, unparsed_args = parser.parse_known_args()
args.wandb_usr = utils.get_wandb_username(args.wandb_usr) # connect ot wandb

args.cuda = not args.no_cuda and torch.cuda.is_available() # use cuda
device = torch.device("cuda" if args.cuda else "cpu")
dtype = torch.float32

utils.create_folders(args) # create folders for saving models etc.
# print(args)
...
# print("model", model)
# print("nodes_dist", nodes_dist) # distribution of number of nodes in the training graphs (i think)
print("dataset info:", dataset_info)
print("dataset_info[n_nodes]:", dataset_info["n_nodes"])
...
optim = get_optim(args, model) # optimizer (adam)
# print(model)
